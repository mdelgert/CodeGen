...
{
    public class MapTemplateDomain : EntityTypeConfiguration<TemplateDomain>
    {
        /// <summary>
        /// Database mappings
        /// </summary>
        public MapTemplateDomain()
        {
            ToTable("CodeGenTemplate");
            HasKey(m => m.Id);
            Property(m => m.TemplateFileName);
            Property(m => m.SingleFile);
            Property(m => m.TemplateFileExtension);
            Property(m => m.TemplateText);
