...
{
    public class MapTokenDomain : EntityTypeConfiguration<TokenDomain>
    {
        /// <summary>
        /// Database mappings
        /// </summary>
        public MapTokenDomain()
        {
            ToTable("CodeGenToken");
            HasKey(m => m.Id);
            Property(m => m.Token);
            Property(m => m.TokenValue);
            Property(m => m.TokenNote);
            Property(m => m.IsSystemToken);
