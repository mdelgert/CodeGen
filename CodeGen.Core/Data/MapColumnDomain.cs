...
{
    public class MapColumnDomain : EntityTypeConfiguration<ColumnDomain>
    {
        /// <summary>
        /// Database mappings
        /// </summary>
        public MapColumnDomain()
        {
            ToTable("CodeGenColumn");
            HasKey(m => m.Id);
            Property(m => m.TableId);
            Property(m => m.ColumnTypeId);
