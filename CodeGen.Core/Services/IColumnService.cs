...
namespace CodeGen.Core.Services
{
    public partial interface IColumnService
    {
        ...
        void ChangeOrder(int id, string direction);
        ...
        /// </summary>
        DataSourceResult Create(ColumnModel objectModel);
        
        /// <summary>
        /// Read - record from database.
        /// </summary>
        ColumnDomain ReadById(int id);
        
        /// <summary>
        /// Update - record in database.
        /// </summary>
        DataSourceResult Update(ColumnModel objectModel);
        
        /// <summary>
        /// Delete - record from database.
        /// </summary>
        DataSourceResult Delete(ColumnModel objectModel);
        ...
        /// </summary>
        IList<ColumnDomain> GetAll();
    
        /// <summary>
        /// Reads all records from database by tableId.
        /// </summary>
        IList<ColumnDomain> GetAllByTableId(int tableId);
