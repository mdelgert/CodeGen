...
namespace CodeGen.Core.Services
{
    public partial interface ITableService
    {
        ...
        /// </summary>
        TableModel Create(TableModel record);
        
        /// <summary>
        /// Create - datasource result record in database.
        /// </summary>
        DataSourceResult CreateDataSourceResult(TableModel record);
        
        
        /// <summary>
        /// Read - record from database.
        /// </summary>
        TableDomain ReadById(int id);
        
        /// <summary>
        /// Update - record in database.
        /// </summary>

        TableModel Update(TableModel record);

        /// <summary>
        /// Update - datasource result record in database.
        /// </summary>
        DataSourceResult UpdateDataSourceResult(TableModel record);
        
        /// <summary>
        /// Delete - record from database.
        /// </summary>
        DataSourceResult Delete(TableModel record);
