...
namespace CodeGen.Core.Services
{
    public partial interface ITokenService
    {
        ...
        /// </summary>
        DataSourceResult Create(TokenModel objectModel);
        
        /// <summary>
        /// Read - record from database.
        /// </summary>
        TokenDomain ReadById(int id);
        
        /// <summary>
        /// Update - record in database.
        /// </summary>
        DataSourceResult Update(TokenModel objectModel);
        
        /// <summary>
        /// Delete - record from database.
        /// </summary>
        DataSourceResult Delete(TokenModel objectModel);
        ...
        /// </summary>
        IList<TokenDomain> GetAll();
    
        #endregion

        #region SystemTokens

        void CreateSystemTokens();

        void CreateSampleTokens();
