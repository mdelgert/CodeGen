...
namespace CodeGen.Core.Services
{
    public partial interface ITemplateService
    {
        ...
        /// Runs all templates
        /// </summary>
        string RunAllTemplates();

        /// <summary>
        /// Run template
        /// </summary>
        string RunTemplate(TemplateDomain template);
        ...
        /// </summary>
        TemplateModel Create(TemplateModel record);

        /// <summary>
        /// Create - datasource result record in database.
        /// </summary>
        DataSourceResult CreateDataSourceResult(TemplateModel record);

        /// <summary>
        /// Read - record from database.
        /// </summary>
        TemplateDomain ReadById(int id);

        ///// <summary>
        ///// Gets template id
        ///// </summary>
        int GetTemplateId(TemplateModel objectModel);

        /// <summary>
        /// Update - record in database.
        /// </summary>
        TemplateModel Update(TemplateModel record);

        /// <summary>
        /// Update - datasource result record in database.
        /// </summary>
        DataSourceResult UpdateDataSourceResult(TemplateModel record);

        /// <summary>
        /// Delete - record from database.
        /// </summary>
        DataSourceResult Delete(TemplateModel record);
