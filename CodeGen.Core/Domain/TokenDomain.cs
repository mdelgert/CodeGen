...
{
    /// <summary>
    /// TokenDomain POC object
    /// </summary>
    public class TokenDomain
    {
        /// <summary>
        /// Gets or sets token primary key
        /// </summary>
        public int Id { get; set; }

        /// <summary>
        /// Gets or sets token name value
        /// </summary>
        ...
        /// <summary>
        /// Gets or sets token note
        /// </summary>
        public string TokenNote { get; set; }

        /// <summary>
        /// Gets or sets IsSystemToken
        /// </summary>
