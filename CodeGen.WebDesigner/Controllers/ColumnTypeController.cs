...
{
    /// <summary>
    /// ColumnType MVC Controller
    /// </summary>
    
    public class ColumnTypeController : Controller
    {

        readonly IColumnTypeService repository = new ColumnTypeService();
        ...
        /// Creates - grid record.
        /// </summary>
        public ActionResult Create(ColumnTypeModel objectModel)
        {
        ...
        /// <summary>
        /// Reads - all records for drop down list.
        /// </summary>
        ...
        /// Updates - grid record.
        /// </summary>
        public ActionResult Update(ColumnTypeModel objectModel)
        {
        ...
        /// Deletes - grid record.
        /// </summary>
        public ActionResult Destroy(ColumnTypeModel objectModel)
        {
