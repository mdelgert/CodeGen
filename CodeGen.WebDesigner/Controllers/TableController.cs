...
namespace CodeGen.WebDesigner.Controllers
{
    public class TableController : Controller
    {
        ...
        readonly ITableService repository = new TableService();
        ...
        /// </summary>
        public ActionResult Create(TableModel objectModel)
        {
            return Json(repository.CreateDataSourceResult(objectModel));
        }
        ...
        /// </summary>
        public ActionResult Update(TableModel objectModel)
        {
            return Json(repository.UpdateDataSourceResult(objectModel));
        }

        /// <summary>
        /// Deletes table record.
        /// </summary>
        public ActionResult Destroy(TableModel objectModel)
        {
